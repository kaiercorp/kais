...
const VisionCLSTrainDetail = () => {
    ...
    const openMultiTestModal = (row: any) => {
        ...
        setModalBody(<FolderTest ref={childComponentRef} selectedTrial={trial} selectedModels={row} engineType={engine.vision_cls_sl}/>)
        openModal()
    }
                            ...
                            <Tab.Container defaultActiveKey='tabs-summary'>
                                ...
                                <Tab.Content>
                                    ...
                                    <Tab.Pane eventKey='tabs-models' id='tabs-models'>
                                        {eventKey === 'tabs-models' && trial && trial.trial_id > 0 && <CLSModelList trial={trial} openMultiTest={openMultiTestModal} downloadModel={handleDownloadModel} engineType={engine.vision_cls_sl}/>}
                                    </Tab.Pane>
