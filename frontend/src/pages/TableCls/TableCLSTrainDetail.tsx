...
import { CLSModelList, TableClsTrialConfigsTable, HyperParameterHistory, LogHistory, TableClsFIContainer, BaseModal, MultiSampleTest } from 'features'
import { BaseModalTitleType, emptyBaseModalTitle, tableClsMultiTest } from 'common'
...
const TableCLSTrainDetail = () => {
    ...
    useEffect(() => {
        ...
        logger.log(`Change Location to ${t('title.table.cls.train', { trial: trial.trial_name })}`)
        updateLocationContextValue({ location: 'table.cls.train', locationValue: { trial: `[${trial.trial_id}] ${trial.trial_name}` } })
    ...
    const openMultiTestModal = (row: any) => {
        ...
        setModalBody(<MultiSampleTest ref={childComponentRef} selectedTrial={trial} selectedModels={row} engineType={engine.table_cls}/>)
        openModal()
    }
                            ...
                            <Tab.Container defaultActiveKey='tabs-summary'>
                                ...
                                <Tab.Content>
                                    ...
                                    <Tab.Pane eventKey='tabs-models' id='tabs-models'>
                                        {eventKey === 'tabs-models' && trial && trial.trial_id > 0 && <CLSModelList trial={trial} openMultiTest={openMultiTestModal} downloadModel={handleDownloadModel} />}
                                    </Tab.Pane>
...
export default TableCLSTrainDetail