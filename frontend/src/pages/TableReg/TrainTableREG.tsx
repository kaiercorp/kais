...
import { RadioGPUWithCPU, SelectDataModal, TableCLSColumnsDnd, TargetMetricReg } from "features"
...
import { tableIndexTypes, emptyTableRegRequest, CreateTrainType } from 'common'
import { emptyErrorsTrainTableCls, validate } from "./TrainTableREGValidator"
import { ProjectContext, TrialContext } from 'contexts'


const TrainTableREG = forwardRef(({ toggle }: any, ref) => {
    ...
    const requestData = trialContextValue.requestData ? trialContextValue.requestData : objDeepCopy(emptyTableRegRequest)
