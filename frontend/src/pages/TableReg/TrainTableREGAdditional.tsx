...
import { RadioGPUWithCPU } from "features";
import { convertUtcTime, objDeepCopy, ApiCreateTrain, ApiFetchTrial } from "helpers";
import { emptyErrors } from "pages/Vision/Cls.SL/TrainValidator";
import { Card, Col, Form, Row } from "react-bootstrap";
import { validate } from "./TrainTableREGValidator";
import { useTranslation } from 'react-i18next'
import { TrialContext } from 'contexts'



const TrainTableREGAdditional = forwardRef(({trialId}: {trialId: number}, ref) => {
    ...
    const handleSubmit = () => {
        const errors = validate(trainMode, requestData, t)
                    ...
                    <Card.Body>
                        ...
                        <Form.Group>
                            <Row>
                                ...
                                <Col xs='8'>{trial?.param?.test_db}</Col>
                            </Row>
                        </Form.Group>
                        <Form.Group>
                            <Row>
...
export default TrainTableREGAdditional