...
const FileUploader = ({ showPreview = true, onFileUpload, disabled = false, disabledMsg, accept='image/*, .npy' }: FileUploaderProps) => {
            ...
            <div className='dz-message needsclick' {...getRootProps()}>
              ...
              {showPreview && selectedFiles.length > 0 ? (
                ...
                <>
                  ...
                  {disabled && disabledMsg && disabledMsg.length > 0 ? (
                    <h5>{disabledMsg}</h5>
                  ) : (
