...
const TargetMetricAD = ({ requestData, handleRequestData}: any) => {
    ...
    return (
            ...
            title={
                <span>
                    ...
                    <PopoverLabel>
                        ...
                        <StatusRow><span>{t(`metric.auroc.desc`)}</span></StatusRow>
                        <StatusRow><span>{t(`metric.prauc.desc`)}</span></StatusRow>
                    </PopoverLabel>
                </span>
            }
            name={'target_metric'}
        ...
        >
            ...
            <option key='target_metric_auroc' value='target_metric.auroc'>
                {t(`metric.auroc`)}
            </option>
            <option key='target_metric_prauc' value='target_metric.prauc'>
                {t(`metric.prauc`)}
            </option>
        </LabelSelect>
    )
