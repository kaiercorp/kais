...
const PredictionImportanceChart = ({ data, toplabel }: any) => {
    if (!data) return <></>
    ...
    return (
        <Card>
            <Card.Header>
            Local explanation for ${toplabel}
            </Card.Header>
            <Card.Body>
            <ChartArea>
                <Row>
                    <LeftCol>NOT {toplabel}</LeftCol>
                    <RightCol>{toplabel}</RightCol>
                </Row>
                <Row>
...
export default PredictionImportanceChart