...
type ProjectEdges struct {
	...
	// UserProject holds the value of the user_project edge.
	UserProject []*UserProject `json:"user_project,omitempty"`
...
// UserProjectOrErr returns the UserProject value or an error if the edge
// was not loaded in eager-loading.
func (e ProjectEdges) UserProjectOrErr() ([]*UserProject, error) {
	if e.loadedTypes[1] {
		return e.UserProject, nil
	}
	return nil, &NotLoadedError{edge: "user_project"}
}
...
// QueryUserProject queries the "user_project" edge of the Project entity.
func (pr *Project) QueryUserProject() *UserProjectQuery {
	return NewProjectClient(pr.config).QueryUserProject(pr)
}
...
func (pr *Project) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", pr.IsUse))
	builder.WriteString(", ")
