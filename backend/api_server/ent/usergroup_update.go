...
func (ugu *UserGroupUpdate) SetLevel(i int) *UserGroupUpdate {
	ugu.mutation.ResetLevel()
	ugu.mutation.SetLevel(i)
	return ugu
}

// SetNillableLevel sets the "level" field if the given value is not nil.
func (ugu *UserGroupUpdate) SetNillableLevel(i *int) *UserGroupUpdate {
	if i != nil {
		ugu.SetLevel(*i)
	}
	return ugu
...
func (ugu *UserGroupUpdate) AddLevel(i int) *UserGroupUpdate {
	ugu.mutation.AddLevel(i)
	return ugu
}

// SetIsUse sets the "is_use" field.
func (ugu *UserGroupUpdate) SetIsUse(b bool) *UserGroupUpdate {
	ugu.mutation.SetIsUse(b)
	return ugu
}

// SetNillableIsUse sets the "is_use" field if the given value is not nil.
func (ugu *UserGroupUpdate) SetNillableIsUse(b *bool) *UserGroupUpdate {
	if b != nil {
		ugu.SetIsUse(*b)
	}
	return ugu
...
func (ugu *UserGroupUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ugu.mutation.Level(); ok {
		_spec.SetField(usergroup.FieldLevel, field.TypeInt, value)
	}
	if value, ok := ugu.mutation.AddedLevel(); ok {
		_spec.AddField(usergroup.FieldLevel, field.TypeInt, value)
	}
	if value, ok := ugu.mutation.IsUse(); ok {
...
// SetLevel sets the "level" field.
func (uguo *UserGroupUpdateOne) SetLevel(i int) *UserGroupUpdateOne {
	uguo.mutation.ResetLevel()
	uguo.mutation.SetLevel(i)
	return uguo
}

// SetNillableLevel sets the "level" field if the given value is not nil.
func (uguo *UserGroupUpdateOne) SetNillableLevel(i *int) *UserGroupUpdateOne {
	if i != nil {
		uguo.SetLevel(*i)
	}
	return uguo
...
// AddLevel adds i to the "level" field.
func (uguo *UserGroupUpdateOne) AddLevel(i int) *UserGroupUpdateOne {
	uguo.mutation.AddLevel(i)
	return uguo
}

// SetIsUse sets the "is_use" field.
func (uguo *UserGroupUpdateOne) SetIsUse(b bool) *UserGroupUpdateOne {
	uguo.mutation.SetIsUse(b)
	return uguo
}

// SetNillableIsUse sets the "is_use" field if the given value is not nil.
func (uguo *UserGroupUpdateOne) SetNillableIsUse(b *bool) *UserGroupUpdateOne {
	if b != nil {
		uguo.SetIsUse(*b)
	}
	return uguo
...
func (uguo *UserGroupUpdateOne) sqlSave(ctx context.Context) (_node *UserGroup, err error) {
	...
	if value, ok := uguo.mutation.Level(); ok {
		_spec.SetField(usergroup.FieldLevel, field.TypeInt, value)
	}
	if value, ok := uguo.mutation.AddedLevel(); ok {
		_spec.AddField(usergroup.FieldLevel, field.TypeInt, value)
	}
	if value, ok := uguo.mutation.IsUse(); ok {
		_spec.SetField(usergroup.FieldIsUse, field.TypeBool, value)
	}
