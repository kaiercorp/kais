...
func (tx *Tx) init() {
	...
	tx.DatasetRoot = NewDatasetRootClient(tx.config)
	...
	tx.Trial = NewTrialClient(tx.config)
	tx.TrialDetails = NewTrialDetailsClient(tx.config)
	tx.TrialStatus = NewTrialStatusClient(tx.config)
